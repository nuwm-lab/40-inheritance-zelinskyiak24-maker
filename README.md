[![Review Assignment Due Date](https://classroom.github.com/assets/deadline-readme-button-22041afd0340ce965d47ae6ef1cefeee28c7c493a6346c4f15d667ab976d596c.svg)](https://classroom.github.com/a/LCD1y6Y7)
...
Створити клас „коло”  
\((x - x_0)^2 + (y - y_0)^2 = R^2\)  
і створити відповідні методи:

- задання координат \((x_0, y_0)\) центру кола та його радіусу \(R\),  
...
- задання координат \((x_0, y_0, z_0)\) центру сфери та її радіусу \(R\),  
  а також виведення цих даних на екран;
- визначення площі поверхні сфери.
